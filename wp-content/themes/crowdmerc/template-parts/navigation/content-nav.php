	...
	<div class="container-fluid">
		<nav class="xs-menus fundpress-menu clear-both">
			<div class="nav-header">
                ...
                <a class="nav-brand nav-logo" href="<?php echo esc_url(home_url('/'));?>" style="display: none">
			...
			<div class="nav-menus-wrapper <?php echo esc_attr($wrap_class); ?>">
				<div class="xs-logo-wraper">
					<a class="nav-brand xs-logo fundpress-logo-v1" href="<?php echo esc_url(home_url('/'));?>">
						<?php if(!empty($site_logo)): ?>
							<img src="<?php echo esc_url($site_logo);  ?>" alt="<?php echo get_bloginfo(); ?>">
						<?php else: ?>
							<?php bloginfo('name'); ?>
